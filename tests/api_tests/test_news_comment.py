...
def test_add_comment_success(get_aut_token,
...
def test_delete_comment_success(get_aut_token,
                                setup_comment):
    """
...
def test_count_comments_success(get_aut_token,
                                setup_and_teardown_news,
                                setup_comment,
                                teardown_comment):
    """
...
def test_update_comment_success(get_aut_token,
                                setup_and_teardown_news,
                                setup_comment,
                                teardown_comment):
    """
